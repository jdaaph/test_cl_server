...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'user_manage_user', 'ukey', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'User.nickname'
        db.alter_column(u'user_manage_user', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.nickname'
        db.alter_column(u'user_manage_user', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=30))
